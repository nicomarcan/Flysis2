...
public class FlightInfoDetailActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setText(this, R.id.flight_info__airline_content, fi.airline.name);
        ...
        setText(this, R.id.flight_info_departure_time_content, formatTime(fi.departure.actual_time));
        setText(this, R.id.flight_info_scheduled_departure_time_content, formatTime(fi.departure.scheduled_time));
        setText(this, R.id.flight_info_boarding_time_content, formatTime(fi.departure.actual_gate_time));
        setText(this, R.id.flight_info_scheduled_boarding_time_content,formatTime(fi.departure.scheduled_gate_time));
        setText(this, R.id.flight_info_arrival_time_content,formatTime(fi.arrival.actual_time));
        setText(this, R.id.flight_info_scheduled_arrival_time_content,formatTime(fi.arrival.scheduled_time));
        setText(this, R.id.flight_info_departure_airport_terminal_content,formatTime(fi.arrival.scheduled_time));
    ...
    private static String formatTime(String og) {
        String formated = "";
        if (og == null) {
            formated = "-";
            return formated;
